...
export default function TicketOverlay({ money, highScore, tickets, stressLevel }) {
  const getStressColor = () => {
    if (stressLevel < 50) return '#22c55e';
    if (stressLevel < 75) return '#facc15';
    return '#ef4444'; 
  };
...
const styles = StyleSheet.create({
  ...
  stressHeader: { color: '#fff', fontWeight: 'bold', fontSize: 14, marginBottom: 5 },
  stressBarBg: { width: '100%', height: 12, backgroundColor: '#334155', borderRadius: 6, overflow: 'hidden', marginBottom: 15 },
  stressBarFill: { height: '100%' },
  ticketHeader: { color: '#cbd5e1', fontWeight: 'bold', fontSize: 16, marginBottom: 10, borderBottomWidth: 1, borderBottomColor: '#475569', paddingBottom: 8 },
  ticketItem: { backgroundColor: '#334155', padding: 10, borderRadius: 6, marginBottom: 8 },
  ticketItemText: { color: '#f8fafc', fontSize: 13, fontWeight: '500' }
});
